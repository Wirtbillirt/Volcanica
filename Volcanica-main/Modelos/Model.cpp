...
Model::Model(const char* file, bool aplicarTransformacionGlobal)
{
	...
	// Solo aplicar transformación si el parámetro lo permite
...
void Model::traverseNode(unsigned int nextNode, glm::mat4 matrix)
{
	...
	// Obtener traslaci�n, rotaci�n y escala si existen
	...
	// Si el nodo tiene una matriz, �sala. Si no, comp�nla con TRS.
	...
	// Si el nodo contiene una malla, c�rgala
